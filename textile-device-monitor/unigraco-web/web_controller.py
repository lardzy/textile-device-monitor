...
class WebInteractiveController:
    def __init__(self, net, device, predictor_params, prob_thresh=0.5, granularity=1.0):
        self.net = net
        self.device = device
    ...
    def add_click(self, x, y, is_positive):
        ...
        pred = self.predictor.get_prediction(
            self.clicker, prev_mask=self._init_mask, gra=self.granularity, phrase=None
        )
